...
from app.agents.execution.registration import company_registration_node
from app.agents.execution.outreach import outreach_node
from app.agents.execution.investor_outreach import investor_outreach_node
...
def create_startup_swarm():
    ...
    builder.add_node("registration", company_registration_node)
    builder.add_node("outreach", outreach_node)
    builder.add_node("investor", investor_outreach_node)
    ...
    builder.add_edge("blueprint", "registration")
    builder.add_edge("blueprint", "outreach")
    builder.add_edge("blueprint", "investor")
